...
const Franchise = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { error: insertError } = await client
        .from('ah_franchise_applications')
        .insert(payload);
      ...
      setError(t('site.franchise.formError'));
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <>
      <SEOHead
        title={t('site.franchise.title')}
        description={t('site.franchise.subtitle')}
        path="/franchise"
      />
              ...
              <form onSubmit={handleSubmit} className="edu-form">
                <div className="edu-form-row">
                  <div className="edu-form-group">
                    ...
                    <input
                      ...
                      placeholder={t('site.franchise.formNamePh')}
                      required
                    />
                  </div>
                  <div className="edu-form-group">
                    ...
                    <input
                      ...
                      value={form.email}
                      onChange={handleChange}
                      placeholder={t('site.franchise.formEmailPh')}
                      required
                    />
                  </div>
                </div>
                ...
                <div className="edu-form-row">
                  <div className="edu-form-group">
                    ...
                    <input
                      ...
                      value={form.phone}
                      onChange={handleChange}
                      placeholder={t('site.franchise.formPhonePh')}
                      required
                    />
                  </div>
                  <div className="edu-form-group">
                ...
                <div className="edu-form-group">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder={t('site.franchise.formExperiencePh')}
                    rows={3}
                    required
                  />
                </div>
                ...
                <div className="edu-form-group">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder={t('site.franchise.formMotivationPh')}
                    rows={4}
                    required
                  />
                </div>
                ...
                <div className="edu-form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder={t('site.franchise.formPortfolioPh')}
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="btn btn-primary edu-form-submit"
                  disabled={submitting}
                >
